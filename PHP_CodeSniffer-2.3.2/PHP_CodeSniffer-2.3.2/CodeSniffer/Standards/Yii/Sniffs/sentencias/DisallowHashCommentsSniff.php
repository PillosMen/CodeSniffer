 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Yii_Sniffs_sentencias_DisallowHashCommentsSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['content'] === 'CDbConnection') {
            ...
            if ((!strpos($name, "models")) )  {
                 $error = 'Se creo la conexion a la base datos en el lugar incorrecto; found %s';
